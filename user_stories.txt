...
Fourth Cycle:
US4:1 User will be able to pull down on the table and the page will refresh the displayed opening/closing times in the drop down tabs on the locaitons. (Sam)
US4:2 User will be able to see static open/close times as well as the updating times when a location dropdown tab is opened. (Matt)
US4:3 User will be able to view Baldwin's demo and main line menu for breakfast/lunch/supper based on time of day. (Micah)
